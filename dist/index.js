...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        switch (name) {
            case "list_budgets":
                return await listBudgetsTool.execute(args);
            case "budget_summary":
                return await budgetSummaryTool.execute(args);
            case "create_transaction":
                return await createTransactionTool.execute(args);
            case "get_unapproved_transactions":
                return await getUnapprovedTransactionsTool.execute(args);
            case "approve_transaction":
                return await approveTransactionTool.execute(args);
            case "handle_overspending":
                return await handleOverspendingTool.execute(args);
            case "auto_distribute_funds":
                return await autoDistributeFundsTool.execute(args);
            ...
            case "reconcile_account":
                return await reconcileAccountTool.execute(args);
            default:
